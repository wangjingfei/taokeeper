...
public class AlarmSettingUtil {
     ...
     * 
     * @param str
     *            类似于的 [/:nileader,yinshi;/nileader:test]^{/:nileader,yinshi;/
     *            nileader:test}
     * @return 可能会返回null
     * @throws Exception
     */
        ...
        try {
            ...
            if (!StringUtil.isBlank(strPathOnlyCanBeExist)) {
                ...
                for (String rule : ruleArray) {
                    ...
                    List<String> pathList = Lists.newArrayList(pathArray[1]);
            ...
            throw new Exception("Error when parseNodePathCheckRuleFromString, String: " + str + ", Error: "
                    + e.getMessage(), e);
        }
