...
public class Initialization extends HttpServlet implements Servlet {
    ...
    private static final int MILLISECONDS_OF_ONE_HOUR = 3600 * 1000;
    ...
    public void init() {
        ...
        timer.schedule(new ZooKeeperNodeChecker(), 5000, //
                MILLISECONDS_OF_ONE_HOUR * SystemConstant.HOURS_RATE_OF_ZOOKEEPER_NODE_CHECK);
        ...
        // ThreadUtil.startThread( new CheckerJob(
        // "/jingwei-v2/tasks/DAILY-TMALL-DPC-META/locks" ) );
    ...
    private void initSystem() {
        ...
        SystemInfo.envName = StringUtil.defaultIfBlank(properties.getProperty("systemInfo.envName"),
                "TaoKeeper-Deploy");
        ...
        DbcpUtil.characterEncoding = StringUtil.defaultIfBlank(
                properties.getProperty("dbcp.characterEncoding"), "UTF-8");
        ...
        SystemConstant.dataStoreBasePath = StringUtil.defaultIfBlank(
                properties.getProperty("SystemConstent.dataStoreBasePath"),
                "/home/yinshi.nc/taokeeper-monitor/");
        SystemConstant.userNameOfSSH = StringUtil.defaultIfBlank(
                properties.getProperty("SystemConstant.userNameOfSSH"), "admin");
        SystemConstant.passwordOfSSH = StringUtil.defaultIfBlank(
                properties.getProperty("SystemConstant.passwordOfSSH"), "123456");
        SystemConstant.portOfSSH = IntegerUtil.defaultIfError(
                properties.getProperty("SystemConstant.portOfSSH"), 22);
