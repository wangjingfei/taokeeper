 ...
 */
public class NodeDataChangedEvent implements Watcher {
    ...
    private static final String CONNECTION_STRING = "test.zookeeper.connection_string:2181,"
            + "test.zookeeper.connection_string2:2181," + "test.zookeeper.connection_string3:2181";
    ...
    public static void main(String[] args) {
        ...
        NodeDataChangedEvent sample = new NodeDataChangedEvent();
